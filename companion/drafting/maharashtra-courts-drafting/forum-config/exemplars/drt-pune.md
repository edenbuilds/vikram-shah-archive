# Forum-config — DRT Pune

```yaml
forum_id: drt-pune
forum_class: tribunal
court_header_line: |
  BEFORE THE HON'BLE DEBTS RECOVERY TRIBUNAL, PUNE.
parties_separator: "VERSUS"
annexure_prefix: "ANNEXURE-"
territorial_note: "Pune, Satara, Sangli, Kolhapur, Solapur, Raigad, Ratnagiri, Sindhudurg (below high-value cut-off)"
appeal_forum: "DRAT, Mumbai"
